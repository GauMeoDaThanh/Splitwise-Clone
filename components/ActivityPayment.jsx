    ...
    >
      ...
      <View className="flex-col px-2" style={{ flex: 1 }}>
        <View className="flex-row items-center" style={{ flexWrap: "wrap" }}>
          ...
          >
            {data.additionalInfo.userPaidId === auth.currentUser.uid
              ? "You"
              : data.additionalInfo.userPaidName}
          </Text>
          <Text>have settled up the expense</Text>
          <Text
          ...
          >
            {data.additionalInfo.expenseName}
          </Text>
        </View>
