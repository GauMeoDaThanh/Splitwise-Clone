                ...
                <View  className ="flex-1 bg-white px-8 pt-8"
                    ...
                    <View className="form space-y-2">
                        ...
                        <TouchableOpacity 
                            ...
                            onPress={()=>{}}
                        >
                            <Text className = "font-xl font-bold text-center text-gray-700 ml-4">Reset</Text>
                        </TouchableOpacity>
                    </View>
            
                    <View className = "flex-row justify-center mt-7">
                        <Text className = "text-gray-500 font-semibold mr-1 mb-3">Already have an account?</Text>
